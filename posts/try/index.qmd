...
#| fig-width: 3
#| code-fold: true
#| fig-cap: "Replication power against the relative sample size of the replication study. The dashed line shows a power of 80%, and the dotted line for 90%."
