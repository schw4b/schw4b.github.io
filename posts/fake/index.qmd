...
![*Science* magazine front cover from 11. February 2011.](science.2011.331.issue-6018.largecover.jpg){width=50%}
...
The main problem was we didn't know that $x_1$, $x_2$, and $x_3$ were the relevant biomarkers. Using univariable screening, with $p \le$ 0.05 for variable selection, `r k` out of a total of `r q` variables were statistically significant; this matches up with the alpha level of 5%.
